...
test.describe('Admission Workflow', () => {
  ...
  test('should complete the 6-step admission wizard with DPDP consent', async ({ page }) => {
    ...
    await page.fill('input[name="primaryContactEmail"]', 'testfamily@saraswati.edu');
    ...
    // Step 6: Confirmation
    await expect(page.locator('h1, h2, h3').filter({ hasText: /Success|Application Submitted/i })).toBeVisible({ timeout: 10000 });
  });
